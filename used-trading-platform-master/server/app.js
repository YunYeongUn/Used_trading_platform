...
const boardContentRouter = require('./routes/boardContent');
const Board_replyRouter = require('./routes/comments');
const productContentRouter = require('./routes/productContent');
const Product_replyRouter = require('./routes/productcomments');
...
app.use('/boardContent',boardContentRouter);
app.use('/boardreply',Board_replyRouter);
app.use('/productContent',productContentRouter);
app.use('/productreply',Product_replyRouter);
